        ...
        <div className="py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul role="list" className="mt-4 space-y-4">
                <li>
                  <a href="/catalog" className="text-base text-gray-500 hover:text-gray-900">
                    All Products
                  </a>
                </li>
                <li>
                  <a href="/catalog?category=new" className="text-base text-gray-500 hover:text-gray-900">
                    New Arrivals
                  </a>
                </li>
                <li>
                  <a href="/catalog?category=bestsellers" className="text-base text-gray-500 hover:text-gray-900">
                    Bestsellers
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul role="list" className="mt-4 space-y-4">
                ...
                <li>
                  <a href="/sustainability" className="text-base text-gray-500 hover:text-gray-900">
                    Sustainability
                  </a>
                </li>
                <li>
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2024 T-Shirt Shop. All rights reserved.
            </p>
          </div>
        </div>
      </div>
